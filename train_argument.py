...
def parser():
    ...
    parser.add_argument('--model', choices=['resnet18', 'vgg16', 'lenet300_100', 'lenet_5'], default='vgg16',
    ...
    parser.add_argument('--alpha', type=float, default=5e-6, help="Coeffiecient for regularizer")
    parser.add_argument('--beta', type=float, default=0.1, help="Coefficient for variance penalty")
